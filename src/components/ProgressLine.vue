...
.progress {
    ...
    .progress-bg {
        ...
        height: 4px;
        border-radius: 2px;
        background: -moz-linear-gradient(left, #439fe6 0%, rgba(57, 122, 187, 0.77) 10%, rgba(73, 99, 160, 0.8) 50%, #063dd5 70%, #1405ed 100%);
        /* FF3.6-15 */
        background: -webkit-linear-gradient(left, #439fe6 0%, rgba(57, 122, 187, 0.77) 10%, rgba(73, 99, 160, 0.8) 50%, #063dd5 70%, #1405ed 100%);
        /* Chrome10-25,Safari5.1-6 */
        background: linear-gradient(to right, #439fe6 0%, rgba(57, 122, 187, 0.77) 10%, rgba(73, 99, 160, 0.8) 50%, #063dd5 70%, #1405ed 100%);
